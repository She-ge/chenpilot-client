...
export const agentConfig = {
  ...
  healthCheckInterval: parseInt(
    process.env.NEXT_PUBLIC_AGENT_HEALTH_CHECK_INTERVAL || "30000"
  ),
  ...
  enableRealTimeUpdates:
    process.env.NEXT_PUBLIC_ENABLE_REAL_TIME_UPDATES === "true",
  ...
  errorMessages: {
    agentUnavailable:
      "Agent service is currently unavailable. Please try again later.",
